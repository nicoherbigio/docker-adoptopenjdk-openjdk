# Building instructions for the Adopt OpenJDK Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/adoptopenjdk-openjdk:17.0-bullseye 17.0/jdk/debian/default/
```
...
docker push nicoherbigde/adoptopenjdk-openjdk:17.0-bullseye
```
